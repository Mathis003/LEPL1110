...
{
    /*
    * Note : 0/5 => OpenCascade arguments Verification (/5) :
    *    ---------------------------------------------------------------------------------
    *    Error in homework.c at line 139 ( c'etait le premier appel a ErrorGmsh() qui etait deja inclu dans le code recu ): 
    *    error code returned by gmsh 6
    *    --------------------------------------------------------------------- Yek Yek !! -
    */
