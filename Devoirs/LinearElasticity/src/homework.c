        ...
        for (iInteg = 0; iInteg < theRule->n; iInteg++)
        {
            ...
            { 
                for (j = 0; j < theSpace->n; j++)
                {
                    ...
                    if (map[i] == map[j]) {
                        theSystem->A[map[i]][map[j]] += (a * dphidx[i] * dphidx[j] + c * dphidy[i] * dphidy[j]) * weightedJac;
                    } else {
                        theSystem->A[map[i]][map[j]] += (b * dphidx[i] * dphidx[j] + c * dphidy[i] * dphidy[j]) * weightedJac;
                    }
                }
